...
function canape_entry_meta() {
	...
	if ( is_sticky() && is_home() && ! is_paged() ) {
		echo '<span class="featured-post">' . esc_html__( 'Featured', 'canapechild' ) . '</span>';
	}
	...
	if ( ! is_single() && ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
		...
		comments_popup_link( esc_html__( 'Leave a comment', 'canapechild' ), esc_html__( '1 Comment', 'canapechild' ), esc_html__( '% Comments', 'canapechild' ) );
		echo '</span>';
	}

	// Edit link
	edit_post_link( esc_html__( 'Edit', 'canapechild' ), '<span class="edit-link">', '</span>' );
}
		...
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			...
			<header class="comment-meta">
				...
				<div class="comment-tools">
					<?php edit_comment_link( esc_html__( 'Edit', 'canapechild' ), '<span class="edit-link">', '</span>' ); ?>
